...
mod test_a {
    ...
    #[test]
    fn sample() {
        assert_eq!(run(read("src/d11/sample.txt").unwrap()).unwrap(), 374);
    }

    #[test]
    fn offical() {
        assert_eq!(run(read("src/d11/input.txt").unwrap()).unwrap(), 9274989);
    }
}
...
mod test_b {
    ...
    #[test]
    fn sample() {
        assert_eq!(run(read("src/d11/sample.txt").unwrap()).unwrap(), 82000210);
    }
