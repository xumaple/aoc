...
mod test_a {
    ...
    #[test]
    fn sample() {
        assert_eq!(run(read("src/d17/sample.txt").unwrap()).unwrap(), 0);
    }

    #[test]
    fn offical() {
        assert_eq!(run(read("src/d17/input.txt").unwrap()).unwrap(), 916);
    }
}
...
mod test_b {
    ...
    // #[test]
    // fn offical() {
    //     assert_eq!(run(read("src/d17/input.txt").unwrap()).unwrap(), 0);
    // }
}
